...
# Standardize features - use separate scalers to avoid overwriting
scaler_all = StandardScaler()
scaler_company = StandardScaler()
X_all = scaler_all.fit_transform(df[all_features])
X_no_external = scaler_company.fit_transform(df[company_cols])
...
# Use separate scalers for each time period to avoid data leakage
